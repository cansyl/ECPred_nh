...
public class fasta2Pepstats_noscale {
	...
	public static Vector<String> parse_single(Vector<String> single) throws IOException{
		String irrel ="B,J,O,U,X,Z";
		List<String> lst_irrel = new ArrayList<String>(Arrays.asList(irrel.split(",")));
	...
	public static void parse_pepstats(String infile, String ECNumber ,String type, long time, String ROOTPATH, String tempDir) throws IOException, InterruptedException{
		BufferedReader br = new BufferedReader(new FileReader(infile));	
		String line ;
		int count = 0 ,vecCount =0;
	...
	public static Vector<String> allFasta(String ECNumber , String type) throws IOException{
		HashMap<String, String> fasta_dict_test = new HashMap<>();
		Vector<String> all_ids = new Vector<String>();
		for (String key : fasta_dict_test.keySet()) 	
			all_ids.add(key);
		return all_ids;
	}
	
	public static void print_vector( String ECNumber,Vector<Vector<String>> vects , String type, long time, String ROOTPATH, String tempDir) throws IOException, InterruptedException{
		//File file = new File(tempDir +"/"+ECNumber+"/pepstats");
		//.mkdirs();		
		String line;
		int count = 0;
