...
public class predictBatchPEPSTATS {
	...
	public static void main(String[] args , Vector<String> ecnums, long time ,String ROOTPATH, String fastaFile, String tempDir) throws IOException, InterruptedException {
		...
		for (int i =0; i< ecnums.size(); i++) {  
		   ...
		   fas.parse_pepstats(cmdArray[4],ecnums.get(i), "1",time, ROOTPATH, tempDir);		  
